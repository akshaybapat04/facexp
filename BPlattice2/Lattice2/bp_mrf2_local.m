function [bel, niter] = bp_mrf2_local(pot, local_evidence, varargin)
...
%
% Input:
% pot(kj,ki) = potential on edge between nodes i,j (must be the same for all pairs)
%   NOTE ORDER IS J THEN I!!!
