function [bel, belE, logZ] = bp_mrf2_lattice2Infer(engine, pot, localEv, varargin)
...
%[belNoCell, niter, msgs] = bp_mrf2_lattice2(kernel, localEvGrid,'method','strips','nstrips',ncols);
[belNoCell, niter, msgs] = bp_mrf2_lattice2(kernel, localEvGrid, 'momentum', 0);
bel2NoCell = pairwise_bel_lattice2(kernel,belNoCell,msgs);
logZ = -bethe_mrf2_lattice(belNoCell,bel2NoCell,kernel,localEvGrid);
%fprintf('niter: %d\n',niter);
